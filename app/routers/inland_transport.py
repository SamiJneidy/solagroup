...
@router.get(path="/get/id/{id}", response_model=schemas.InlandTransport, status_code=status.HTTP_200_OK, tags=["Sources"])
...
# @router.get(path="/get/zipcode/{zipcode}", response_model=schemas.InlandTransport, status_code=status.HTTP_200_OK, tags=["Sources"])
...
@router.get(path="/get", response_model=list[schemas.InlandTransport], status_code=status.HTTP_200_OK, tags=["Sources"])
...
@router.post(path="/create", response_model=schemas.InlandTransport, status_code=status.HTTP_200_OK, tags=["Sources"])
...
@router.put(path="/update/{id}", response_model=schemas.InlandTransport, status_code=status.HTTP_200_OK, tags=["Sources"])
