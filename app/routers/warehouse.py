...
async def create_warehouse(data: schemas.WarehouseCreate, current_user = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def update_warehouse(id: int, data: schemas.WarehouseUpdate, current_user = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def delete_warehouse(id: int, current_user = Depends(get_current_user), db: Session = Depends(get_db)):
